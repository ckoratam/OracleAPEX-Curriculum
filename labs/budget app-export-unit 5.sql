...
--   Application:     106
--   Name:            BUDGET APP
--   Date and Time:   19:16 Monday February 20, 2017
...
,p_last_upd_yyyymmddhh24miss=>'20170220191627'
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'CHAITANYA'
,p_last_upd_yyyymmddhh24miss=>'20170209162335'
);
wwv_flow_api.create_page_plug(
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'CHAITANYA'
,p_last_upd_yyyymmddhh24miss=>'20170209164847'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(14943720001700)
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(18737084004270)
,p_install_id=>wwv_flow_api.id(14943720001700)
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(51163859007888)
,p_install_id=>wwv_flow_api.id(14943720001700)
